...
from app.ingestion.od_sales import SOURCE_TYPE as OD_SALES_SOURCE_TYPE
...
SUPPORTED_TYPES = {GOODMAN_SOURCE_TYPE, R32_ENGINEERING_SOURCE_TYPE, OD_SALES_SOURCE_TYPE}
